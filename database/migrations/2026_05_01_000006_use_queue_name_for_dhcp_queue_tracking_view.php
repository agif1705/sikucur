...
return new class extends Migration
{
    ...
    {
        $this->replaceView(useQueueCommentStatus: true);
    }

    private function replaceView(bool $useQueueCommentStatus = false): void
    {
        ...
        $queueNameStatusCheck = $useQueueCommentStatus
            ? 'queue_comment IS NULL OR btrim(queue_comment) = \'\''
            : 'queue_name IS NULL OR btrim(queue_name) = \'\'';
        $queueNameStatusLabel = $useQueueCommentStatus
            ? 'Queue Belum Ada Comment'
            : 'Queue Belum Ada Nama';
        ...
        DB::statement(<<<SQL
            ...
            SELECT
                ...
                CASE
                    ...
                    WHEN {$queueNameStatusCheck} THEN '{$queueNameStatusLabel}'
