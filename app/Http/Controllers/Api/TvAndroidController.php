...
class TvAndroidController extends Controller
{
    ...
    public function mapTv(string $slug): JsonResponse
    {
        $nagari = $this->resolveNagari($slug);
        ...
        return response()->json([
            'message' => 'Data TV berhasil diambil',
            'data' => $this->tvData($nagari),
        ]);
    }

    public function runningText(string $slug): JsonResponse
    {
        $nagari = $this->resolveNagari($slug);
        ...
        return response()->json([
            'message' => 'Running text berhasil diambil',
            'data' => [
                'running_text' => $nagari->TvInformasi?->running_text,
            ],
        ]);
    }
    ...
    private function tvData(Nagari $nagari): array
    {
